            ...
            <div className="bg-[#1A1033] backdrop-blur-sm rounded-3xl p-8 md:p-12 relative">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="relative group">
                        ...
                        {errors.companyName && <p className="text-red-500 text-sm mx-12">{errors.companyName}</p>}
                    </div>
                    ...
                    <div className="relative group">
                        ...
                        {errors.primaryLocation && <p className="text-red-500 text-sm mx-12">{errors.primaryLocation}</p>}
                    </div>
