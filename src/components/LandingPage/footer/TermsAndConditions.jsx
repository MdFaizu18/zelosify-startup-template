                ...
                <div className="prose prose-invert prose-purple max-w-none">
                    ...
                    <div className="bg-[#1A1033] rounded-xl p-8 mb-8">
                        ...
                        <p className="text-purple-200 mb-4">
                            We are Zelosify Pvt Ltd ("Company", "we", "us", "our"), a company registered in India at [bangalore].
                        </p>
                        <p className="text-purple-200 mb-4">
                            We operate the website http://www.zelosify.com (the "Site"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").
                        </p>
                        <p className="text-purple-200 mb-4">
                            You can contact us by email at support@zelosify.com or by mail to [Bangalore].
                        </p>
                        <p className="text-purple-200 mb-4">
                            These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and Zelosify Pvt Ltd, concerning your access to and use of the Services. By accessing the Services, you confirm that you have read, understood, and agreed to be bound by these Legal Terms.
                        </p>
                        <p className="text-white mb-4 font-bold">
                            IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.
                        </p>
                        <p className="text-purple-200 mb-4">
                            We will provide you with prior notice of any scheduled changes to the Services you are using. The modified Legal Terms will become effective upon posting or notifying you by notification@zelosify.com, as stated in the email message. By continuing to use the Services after the effective date of any changes, you agree to be bound by the modified terms.
                        </p>
                        <p className="text-purple-200 mb-4">
                    ...
                    <section id="section-2" className="mb-12 scroll-mt-80">
                        ...
                        <h3 className="text-xl font-semibold text-white mt-4">Our Intellectual Property</h3>
                        <p className="text-purple-200 mt-4">We are the owner or the licensee of all intellectual property rights in our Services, including all source code, databases, functionality, software, website designs, audio, video, text, photographs, and graphics in the Services (collectively, the "Content"), as well as the trademarks, service marks, and logos contained therein (the "Marks").</p>
                        <p className="text-purple-200 mt-4">Our Content and Marks are protected by copyright and trademark laws (and various other intellectual property rights and unfair competition laws) and treaties in the United States and around the world.</p>
                        <p className="text-purple-200 mt-4">The Content and Marks are provided in or through the Services "AS IS" for your internal business purpose only.</p>

                        <h3 className="text-xl font-semibold text-white mt-8">Your Use of Our Services</h3>
                        <p className="text-purple-200 mt-4">Subject to your compliance with these Legal Terms, including the "PROHIBITED ACTIVITIES" section below, we grant you a non-exclusive, non-transferable, revocable license to:</p>
                        ...
                        <p className="text-purple-200 mt-4">Except as set out in this section or elsewhere in our Legal Terms, no part of the Services and no Content or Marks may be copied, reproduced, aggregated, republished, uploaded, posted, publicly displayed, encoded, translated, transmitted, distributed, sold, licensed, or otherwise exploited for any commercial purpose whatsoever, without our express prior written permission.</p>
                        <p className="text-purple-200 mt-4">If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: support@zelosify.com. If we ever grant you permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
                        <p className="text-purple-200 mt-4">We reserve all rights not expressly granted to you in and to the Services, Content, and Marks.
                        ...
                        <h3 className="text-xl font-semibold text-white mt-8">Your Submissions and Contributions</h3>
                        <p className="text-purple-200 mt-4">Please review this section and the "PROHIBITED ACTIVITIES" section carefully prior to using our Services to understand the (a) rights you give us and (b) obligations you have when you post or upload any content through the Services.</p>

                        <h3 className="text-xl font-semibold text-white mt-8">Submissions</h3>
                        <p className="text-purple-200 mt-4">By directly sending us any question, comment, suggestion, idea, feedback, or other information about the Services ("Submissions"), you agree to assign to us all intellectual property rights in such Submission. You agree that we shall own this Submission and be entitled to its unrestricted use and dissemination for any lawful purpose, commercial or otherwise, without acknowledgment or compensation to you.</p>

                        <h3 className="text-xl font-semibold text-white mt-8">Contributions</h3>
                        <p className="text-purple-200 mt-4">By directly sending us any question, comment, suggestion, idea, feedback, or other information about the Services ("Submissions"), you agree to assign to us all intellectual property rights in such Submission. You agree that we shall own this Submission and be entitled to its unrestricted use and dissemination for any lawful purpose, commercial or otherwise, without acknowledgment or compensation to you.</p>
                        <p className="text-purple-200 mt-4">You understand that Contributions may be viewable by other users of the Services and possibly through third-party websites.</p>
                        <p className="text-purple-200 mt-4">When you post Contributions, you grant us a license (including use of your name, trademarks, and logos):</p>
                        <p className="text-purple-200 mt-4">By posting any Contributions, you grant us an unrestricted, unlimited, irrevocable, perpetual, non-exclusive, transferable, royalty-free, fully-paid, worldwide right, and license to: use, copy, reproduce, distribute, sell, resell, publish, broadcast, retitle, store, publicly perform, publicly display, reformat, translate, excerpt (in whole or in part), and exploit your Contributions (including, without limitation, your image, name, and voice) for any purpose, commercial, advertising, or otherwise, to prepare derivative works of, or incorporate into other works, your Contributions, and to sublicense the licenses granted in this section. Our use and distribution may occur in any media formats and through any media channels.
                            This license includes your use of your name, company name, and franchise name, as applicable, and any of the trademarks, service marks, trade names, logos, and personal and commercial images you provide.</p>

                        <h3 className="text-xl font-semibold text-white mt-8">You Are Responsible for What You Post or Upload</h3>
                        ...
                        <h3 className="text-xl font-semibold text-white mt-8">Copyright Infringement</h3>
                        <p className="text-purple-200 mt-4">We respect the intellectual property rights of others. If you believe that any material available on or through the Services infringes upon any copyright you own or control, please immediately refer to the "COPYRIGHT INFRINGEMENTS" section below.</p>
                    ...
                    <section id="section-5" className="mb-12 scroll-mt-80">
                        <h2 className="text-2xl font-bold text-white mb-4">5. Purchases and Payment</h2>
                        <p className="text-purple-200 mt-4">
                    ...
                    <section id="section-6" className="mb-12 scroll-mt-80">
                        <h2 className="text-2xl font-bold text-white mb-4">6. Subscriptions</h2>

                        <h3 className="text-xl font-semibold text-white mt-8">Billing and Renewal</h3>
                        <p className="text-purple-200 mt-4">
                            The subscription shall not renew automatically. Prior to the expiration of your contract term, we shall contact you via email to communicate the applicable renewal costs should you elect to continue your subscription.
                        </p>

                        <h3 className="text-xl font-semibold text-white mt-8">Free Trial</h3>
                        <p className="text-purple-200 mt-4">
                        ...
                        <h3 className="text-xl font-semibold text-white mt-8">Cancellation</h3>
                        <p className="text-purple-200 mt-4">
                            All purchases are non-refundable. You can cancel your subscription at any time by logging into your account. Your cancellation will take effect at the end of the current paid term. If you have any questions or are unsatisfied with our Services, please email us at <a href="mailto:support@zelosify.com" className="text-purple-400 hover:text-white">support@zelosify.com</a>.
                        </p>
                    </section>
                    ...
                    <section id="section-8" className="mb-12 scroll-mt-80">
                        <h2 className="text-2xl font-bold text-white mb-4">8. Third-Party Websites and Content</h2>
                        <p className="text-purple-200 mt-4">
                        ...
                        <p className="text-purple-200 mt-4">
                            Inclusion of, linking to, or permitting the use or installation of any Third-Party Websites or any Third-Party Content does not imply approval or endorsement thereof by us. If you decide to leave the Services and access Third-Party Websites or to use or install any Third-Party Content, you do so at your own risk, and you should be aware these Legal Terms no longer govern.
                        </p>
                        <p className="text-purple-200 mt-4">
                    ...
                    <section id="section-9" className="mb-12 scroll-mt-80">
                        <h2 className="text-2xl font-bold text-white mb-4">9. Services Management</h2>
                        <p className="text-purple-200 mt-4">
                        ...
                        <ul className="list-disc pl-6 space-y-2 text-purple-200 mt-6">
                            ...
                            <li>
                                In our sole discretion and without limitation, remove from the Services or otherwise disable all files and content that are excessive in size or are in any way burdensome to our systems.
                            </li>
                            <li>
                    ...
                    <section id="section-10" className="mb-12 scroll-mt-80">
                        ...
                        <p className="text-purple-200 mt-4">
                            ...
                            <a href="http://www.zelosify.com/privacy" className="text-purple-400 hover:text-white transition-colors duration-300">
                    ...
                    <section id="section-11" className="mb-12 scroll-mt-80">
                        <h2 className="text-2xl font-bold text-white mb-4">11. Copyright Infringements</h2>
                        <p className="text-purple-200 mt-4">
                    ...
                    <section id="section-12" className="mb-12 scroll-mt-80">
                        ...
                        <p className="text-purple-200 mt-4">
                            These Legal Terms shall remain in full force and effect while you use the Services. <strong>WITHOUT LIMITING ANY OTHER PROVISION OF THESE LEGAL TERMS</strong>, we reserve the right to, in our sole discretion and without notice or liability:
                        </p>
                        <ul className="list-disc pl-6 space-y-2 text-purple-200 mt-6">
                            <li>
                                Deny access to and use of the Services (including blocking certain IP addresses) to any person for any reason or for no reason. This includes, without limitation, for breach of any representation, warranty, or covenant contained in these Legal Terms or of any applicable law or regulation.
                            </li>
                            <li>
                                Terminate your use or participation in the Services or delete your account and any content or information that you posted at any time, without warning, in our sole discretion.
                            </li>
                        </ul>
                        <p className="text-purple-200 mt-4">
                    ...
                    <section id="section-13" className="mb-12 scroll-mt-80">
                        <h2 className="text-2xl font-bold text-white mb-4">13. Modifications and Interruptions</h2>
                        <p className="text-purple-200 mt-4">
                    ...
                    <section id="section-14" className="mb-12 scroll-mt-80">
                        ...
                        <p className="text-purple-200 mt-4">
                            These Legal Terms shall be governed by and defined following the laws of India. Zelosify Pvt Ltd and yourself irrevocably consent that the courts of India shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.
                        </p>
                    </section>
                    ...
                    <section id="section-15" className="mb-12 scroll-mt-80">
                        ...
                        <h3 className="text-xl font-semibold text-white mt-8">Informal Negotiations</h3>
                        <p className="text-purple-200 mt-4">
                            To expedite resolution and control the cost of any dispute, controversy, or claim related to these Legal Terms ("Dispute"), you and we agree to first attempt to negotiate any Dispute (except those expressly provided below) informally for at least 30 days before initiating arbitration. Such informal negotiations commence upon written notice from one Party to the other Party.
                        </p>

                        <h3 className="text-xl font-semibold text-white mt-8">Binding Arbitration</h3>
                        <p className="text-purple-200 mt-4">
                            Any Dispute arising out of or in connection with these Legal Terms shall be finally resolved by the International Commercial Arbitration Court under the European Arbitration Chamber. The seat, legal place, or arbitration shall be in Bangalore, India. The language of the proceedings shall be English.
                        </p>

                        <h3 className="text-xl font-semibold text-white mt-8">Restrictions</h3>
                        <p className="text-purple-200 mt-4">
                            You agree that any arbitration shall be limited to the Dispute between you and us individually. You further agree that:
                        </p>
                        <ul className="list-disc pl-6 space-y-2 text-purple-200 mt-6">
                            ...
                            <li>There is no right or authority for any Dispute to be brought in a purported representative capacity on behalf of the public or any other persons.</li>
                        </ul>

                        <h3 className="text-xl font-semibold text-white mt-8">Exceptions to Informal Negotiations and Arbitration</h3>
                        <p className="text-purple-200 mt-4">
                    ...
                    <section id="section-16" className="mb-12 scroll-mt-80">
                        <h2 className="text-2xl font-bold text-white mb-4">16. Corrections</h2>
                        <p className="text-purple-200 mt-4">
                    ...
                    <section id="section-17" className="mb-12 scroll-mt-80">
                        <h2 className="text-2xl font-bold text-white mb-4">17. Disclaimer</h2>
                        <p className="text-purple-200 mt-4">
                            <strong>
                    ...
                    <section id="section-18" className="mb-12 scroll-mt-80">
                        <h2 className="text-2xl font-bold text-white mb-4">18. Limitations of Liability</h2>
                        <p className="text-purple-200 mt-4">
                            <strong>
                        ...
                        <p className="text-purple-200 mt-4">
                            CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT ALLOW LIMITATIONS ON IMPLIED WARRANTIES OR THE EXCLUSION OR LIMITATION
                            OF CERTAIN DAMAGES. IF THESE LAWS APPLY TO YOU, SOME OR ALL OF THE ABOVE DISCLAIMERS OR LIMITATIONS MAY NOT APPLY TO YOU,
                    ...
                    <section id="section-20" className="mb-12 scroll-mt-80">
                        <h2 className="text-2xl font-bold text-white mb-4">20. User Data</h2>
                        <p className="text-purple-200 mt-4">
                    ...
                    <section id="section-21" className="mb-12 scroll-mt-80">
                        <h2 className="text-2xl font-bold text-white mb-4">21. Electronic Communications, Transactions, and Signatures</h2>
                        <p className="text-purple-200 mt-4">
                            ...
                            and you agree that all agreements, notices, disclosures, and other communications we provide to you electronically, via email and on the Services, satisfy
                    ...
                    <section id="section-22" className="mb-12 scroll-mt-80">
                        ...
                        <p className="text-purple-200 mt-4">
                            These Legal Terms and any policies or operating rules posted by us on the Services or in respect to the Services constitute the entire agreement and
                            understanding between you and us. Our failure to exercise or enforce any right or provision of these Legal Terms shall not operate as a waiver of such
                            right or provision. These Legal Terms operate to the fullest extent permissible by law.
                        </p>
                        <p className="text-purple-200 mt-4">
                            We may assign any or all of our rights and obligations to others at any time. We shall not be responsible or liable for any loss, damage, delay, or failure
                            to act caused by any cause beyond our reasonable control. If any provision or part of a provision of these Legal Terms is determined to be unlawful, void,
                            or unenforceable, that provision or part of the provision is deemed severable from these Legal Terms and does not affect the validity and enforceability of
                            any remaining provisions.
                        </p>
                        <p className="text-purple-200 mt-4">
                            There is no joint venture, partnership, employment or agency relationship created between you and us as a result of these Legal Terms or use of the
                            Services. You agree that these Legal Terms will not be construed against us by virtue of having drafted them.
                        </p>
                        <p className="text-purple-200 mt-4">
                            You hereby waive any and all defenses you may have based on the electronic form of these Legal Terms and the lack of signing by the parties hereto to
                    ...
                    <section id="section-23" className="mb-12 scroll-mt-80">
                        ...
                        <p className="text-purple-200 mt-4">
                            <a href="mailto:support@zelosify.com" className="text-purple-300 hover:text-white transition-colors duration-300">
