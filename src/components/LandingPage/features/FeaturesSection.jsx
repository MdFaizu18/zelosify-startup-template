export default function FeaturesSectionTwo() {
    ...
    return (
        <section className="bg-[#1A1033] py-20 px-4  sm:px-32" id="features">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    {features.map((feature, index) => (
                        <div
                            key={index}
                            className="bg-[#0F071F]/50 rounded-xl p-8 hover:bg-[#090413] transition-colors duration-300 flex flex-col items-center text-center"
                        >
