...
export default function RegisterPage() {
    return (
        <>
            ...
            <div className="min-h-screen bg-[#0F0720] flex items-center justify-center p-4 pt-32">
                <div className="bg-[#1A1033] rounded-3xl p-8 md:p-12 w-full max-w-5xl grid md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-6">
                        ...
                        <p className="text-center text-purple-200">
                            ...
                            <Link to="/login" className="text-purple-500 hover:text-purple-400">Sign In To Explore</Link>
                        </p>
                    </div>
                </div>
            </div>
