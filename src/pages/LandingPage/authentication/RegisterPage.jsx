...
export default function RegisterPage() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        if (!emailError && email && !passwordError && password && !confirmPasswordError && confirmPassword) {
                            ...
                            <form onSubmit={handleSubmit} className="max-w-md mx-auto">
                                <div className="mb-4">
                                    ...
                                    <div className="relative">
                                        ...
                                        />
                                        <svg className="w-5 h-5 text-purple-300/50 absolute right-3 top-2.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div className="mb-4">
                                    ...
                                    <input
                                        ...
                                        required
                                        className={`w-full px-4 py-2 rounded-md bg-[#12071A] border ${passwordError ? "border-red-600" : "border-purple-900/50"
                                ...
                                <div className="mb-4">
                                    ...
                                    <input
                                        ...
                                        autoComplete="new-password"
                                        required
                                        className={`w-full px-4 py-2 rounded-md bg-[#12071A] border ${confirmPasswordError ? "border-red-600" : "border-purple-900/50"
                                            } text-white placeholder-purple-300/50 focus:outline-none focus:ring-2 ${confirmPasswordError ? "focus:ring-red-600" : "focus:ring-purple-600"
                                            }`}
